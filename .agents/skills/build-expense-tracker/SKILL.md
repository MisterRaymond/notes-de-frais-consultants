...
description: Construit ou fait évoluer l'application de notes de frais consultants (Next.js + MUI) selon le cahier des charges de l'entreprise. À utiliser dès qu'on demande de créer, modifier ou étendre l'app de notes de frais.
---
